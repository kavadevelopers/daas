<div class="page-header">
    <div class="row align-items-end">
        ...
        <div class="col-md-6 text-right">
            <a href="<?= base_url('user/new_sales_person') ?>" class="btn btn-info btn-sm">
                ...
                <tbody>
                    <?php foreach ($user as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('user/edit_sales_person/').$value['id'] ?>" class="btn btn-primary btn-mini">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <a href="<?= base_url('user/delete_sales_person/').$value['id'] ?>" class="btn btn-danger btn-mini btn-delete">
