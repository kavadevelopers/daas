<div class="page-header">
    <div class="row align-items-end">
        ...
        <div class="col-md-6 text-right">
            <a href="<?= base_url('user/new_admin') ?>" class="btn btn-info btn-sm">
                ...
                <tbody>
                    <?php foreach ($user as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('user/edit_admin/').$value['id'] ?>" class="btn btn-primary btn-mini">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <a href="<?= base_url('user/delete_admin/').$value['id'] ?>" class="btn btn-danger btn-mini btn-delete">
