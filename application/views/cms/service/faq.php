...
<div class="page-body">
    <div class="row">
        ...
        <?php if($_e == 0){ ?>
            <div class="col-md-4">
                <div class="card">
                    <form method="post" action="<?= base_url('servicecms/save_faq') ?>">
        ...
        <?php }else{ ?>
            <div class="col-md-4">
                <div class="card">
                    <form method="post" action="<?= base_url('servicecms/update_faq') ?>">
                        <div class="card-block">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Question <span class="-req">*</span></label>
                        ...
                        <div class="card-footer text-right">
                            <a href="<?= base_url('servicecms/faq') ?>" class="btn btn-danger">
                            ...
                            <?php foreach ($list as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('servicecms/edit_faq/').$value['id'] ?>" class="btn btn-primary btn-mini">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a href="<?= base_url('servicecms/delete_faq/').$value['id'] ?>" class="btn btn-danger btn-mini btn-delete">
